        ...
        try {
            ...
            if (mpstatLine == null) {
                ...
                while((mpstatLine = mpstatReader.readLine()) != null) {
                    ...
                    if (measureMode == LinuxClient.CONSERVATIVE) {
                        selected_idle = (selected_idle < candidate_idle)?selected_idle:candidate_idle;
                    } else if (measureMode == LinuxClient.OPTIMISTIC) {
                        selected_idle = (selected_idle > candidate_idle)?selected_idle:candidate_idle;
                    }
                    ++i;
                }
